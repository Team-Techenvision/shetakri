...
?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form name='addTaluka'  method="POST" action="">
                                ...
                                <div class="form-group">
                                    <h5>Taluka Name<span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <input type="text" name="talukaname" id="talukaname" class="form-control" > </div>
                                </div>
    ...
    $(function() {  
      ...
      $("form[name='addTaluka']").validate({
        ...
        messages: {
          talukaname:{
            required : "Please provide taluka." , 
