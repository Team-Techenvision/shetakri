                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#verticalcenter" class="model_img img-fluid" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#tooltipmodals" class="model_img img-fluid" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- sample modal content -->
                                <div id="grid-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="grid-title" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                ...
                                <!-- /.modal -->
                                <img src="../assets/images/alert/model.png" alt="default" data-toggle="modal" data-target="#grid-modal" class="model_img img-fluid" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
