                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-3">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-top-left">Top Left</button>
                            </div>
                            <div class="col-md-3 col-sm-12 mb-3">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-top-center">Top Center</button>
                            </div>
                            <div class="col-md-3 col-sm-12 mb-3">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-top-right">Top Right</button>
                            </div>
                            <div class="col-md-3 col-sm-12 mb-3">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-top-full">Top Full Width</button>
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-bottom-left">Bottom Left</button>
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-bottom-center">Bottom Center</button>
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-bottom-right">Bottom Right</button>
                            </div>
                            <div class="col-md-3 col-sm-12">
                                <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    id="pos-bottom-full">Bottom Full Width</button>
                            </div>
                        </div>
                    </div>
                </div>
