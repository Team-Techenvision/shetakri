                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <div class="row">
                                <div class="col-md-6">
                                    <h4 class="card-title">Taluka</h4>
                                </div>
                                <div class="col-md-3 ">
                                </div>
                                <div class="col-md-3 center">
                                   <a href="add-taluka.php"> <button type="submit" class="btn btn-info" name="submit">Add Taluka</button></a>
                                </div>
                              </div>
