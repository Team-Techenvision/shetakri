            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime</code> class for Default
                                        PickaDate Picker.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickadate-clear-buttons</code> class to
                                        hide clear button from calendar.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <span class="ti-alarm-clock"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime-minmax-range</code> class for
                                        maximum starting time and minimum ending time.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <span class="ti-alarm-clock"></span>
                                ...
                                <div class="form-group">
                                    <label>Change Formats</label>
                                    <h6 class="card-subtitle">Use <code>.pickadate-change-format</code> class to change
                                        time and date display formats.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <span class="ti-alarm-clock"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use <code>.pickatime-format-label</code> class to
                                        display time label format.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <span class="ti-alarm-clock"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">Use <code>.pickatime-formatTime-display</code> class to
                                        display time format.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <span class="ti-alarm-clock"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">Use for to show last 5 time limits and also shows current
                                        time Limitation.</h6>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime-disable</code> for disable set
                                        of time.</h6>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime-intervals</code> class to
                                        display time in Intervals.</h6>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime-timedisable-object</code>
                                        class and using objects as a range of times</h6>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime-timedisable-integer</code>
                                        class and using integers as hours (0 to 23)</h6>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <h6 class="card-subtitle">To use add <code>.pickatime-closeuser-action</code> class
                                        and use for When a time is selected or the "clear" button is pressed, the picker
                                        closes.</h6>
                                    <div class="input-group">
                                ...
                                <div class="form-group">
                                    <label>Picker Events</label>
                                    <h6 class="card-subtitle">To use add just <code>pickatime-events</code> and to
                                        verify open console.</h6>
                                    <div class="input-group">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">With API</h4>
                                <div class="form-group">
                                    <label>Open and Close Calendar</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <button id="api_button_open" class="btn btn btn-primary"
                                                type="button">Open</button>
                                            <button id="api_button_close" class="btn btn btn-danger" type="button"
                                                style="display:none">Close</button>
                                        </div>
                                        <input autofocus type="text" id="api_picker_open"
                                            class="datepicker form-control" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Clear the Date</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <button id="api_button_clear" class="btn btn btn-danger" type="button">Clear
                                                date</button>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label>Clear the Date With Inline Button</label>
                                    <div class="input-group">
                                        <input type="text" class="datepicker form-control" id="api_picker_clear_b"
                                            value="15 October, 2010" data-value="2012-10-15">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-danger input-clear" id="api_button_clear_b"
