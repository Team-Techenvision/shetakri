                    ...
                    <div class="col-12">
                                    ...
                                    <table id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="7">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>9</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/3.jpg" alt="user" width="40" class="rounded-circle" /> Govinda jalan</a>
                                                </td>
                                                <td>govinda@gmail.com</td>
                                                <td>+345 456 789</td>
                                                <td><span class="label label-success">Accountant</span></td>
                                            ...
                                            <tr>
                                                <td>11</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/5.jpg" alt="user" width="40" class="rounded-circle" /> Varun Dhawan</a>
                                                </td>
                                    ...
                                    <table id="demo-foo-row-toggler" class="table table-bordered" data-toggle-column="first">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/8.jpg" alt="user" width="40" class="rounded-circle" /> Shraddha Kapoor</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/1.jpg" alt="user" width="40" class="rounded-circle" /> Akshay Kumar</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>5</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/5.jpg" alt="user" width="40" class="rounded-circle" /> Steve Jobs</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>6</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/4.jpg" alt="user" width="40" class="rounded-circle" /> Anil Kapoor</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>7</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/3.jpg" alt="user" width="40" class="rounded-circle" /> Priyank Deshmukh</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>8</td>
                                                <td>
                                                    <a href="javascript:void(0)"><img src="../../assets/images/users/2.jpg" alt="user" width="40" class="rounded-circle" /> Genelia Deshmukh</a>
                                                </td>
                                ...
                                <div class="accordion" id="accordionTable">
                                    <div class="card m-b-5">
                                        ...
                                        <div id="col1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionTable">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table id="demo-foo-accordion" class="table table-bordered m-b-0 toggle-arrow-tiny" data-filtering="true" data-cascade="true" data-sorting="true" data-toggle-column="last" data-paging="true" data-paging-size="6">
                                                        <thead>
                                      ...
                                      <div class="card">
                                        ...
                                        <div id="col2" class="collapse" aria-labelledby="heading2" data-parent="#accordionTable">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table id="demo-foo-accordion2" class="table table-bordered m-b-0 toggle-arrow-tiny" data-filtering="true" data-cascade="true" data-sorting="true" data-toggle-column="last" data-paging="true" data-paging-size="6">
                                                        <thead>
                                                            <tr class="footable-filtering">
                                                                <th data-toggle="true"> First Name </th>
                                                                <th> Last Name </th>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-pagination" class="table table-bordered toggle-arrow-tiny" data-cascade="true"
                                    data-sorting="true" data-toggle-column="last" data-paging="true" data-paging-size="6">
                                        <thead>
                                            <tr>
                                                <th data-toggle="true"> First Name </th>
                                                <th> Last Name </th>
