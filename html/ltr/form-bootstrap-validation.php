            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Browser default Validation</h4>
                                <form>
                                    <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check custom-control custom-checkbox mr-sm-2">
                                            <input type="checkbox" class="custom-control-input form-check-input" id="customControlAutosizing">
                                            <label class="custom-control-label form-check-label" for="customControlAutosizing">Agree to terms and conditions</label>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate>
                                  ...
                                  <div class="form-group">
                                    <div class="form-check custom-control custom-checkbox mr-sm-2">
                                        <input type="checkbox" class="custom-control-input form-check-input" id="invalidcheck1" required>
                                        <label class="custom-control-label form-check-label" for="invalidcheck1">Agree to terms and conditions</label>
                                        <div class="invalid-feedback">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Server side Validation</h4>
                                <form>
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check custom-control custom-checkbox mr-sm-2">
                                            <input type="checkbox" class="custom-control-input is-invalid form-check-input" id="invalidcheck2" required>
                                            <label class="custom-control-label form-check-label" for="invalidcheck2">Agree to terms and conditions</label>
                                            <div class="invalid-feedback">
                                                You must agree before submitting.
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="was-validated">
                                    ...
                                    <div class="mb-3 form-group">
                                        <div class="form-check custom-control custom-checkbox mr-sm-2">
                                            <input type="checkbox" class="custom-control-input is-invalid form-check-input" id="invalidcheck3" required>
                                            <label class="custom-control-label form-check-label" for="invalidcheck3">Agree to terms and conditions</label>
                                            <div class="invalid-feedback">
