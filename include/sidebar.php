            ...
            <ul id="sidebarnav">
                ...
                <li>
                    ...
                    <div class="user-profile dropdown m-t-20">
                        <div class="user-pic">
                            <img src="../assets/images/users/logo.jpg" alt="users" class="rounded-circle img-fluid" />
                        </div>
                        <div class="user-content hide-menu m-t-10">
                            <h5 class="m-b-10 user-name font-medium">Abhijeet Suryawanshi</h5>
                ...
                <li class="sidebar-item">
                    <a href="advertise.php" class="sidebar-link">
                        <i class="mdi mdi-credit-card-plus"></i>
